...
class createcustomer(FlaskForm):
    C_id=StringField('ID',validators=[DataRequired(),Length(min=4,max=15)])
    C_email=StringField('Email',validators=[DataRequired(),Email()])
    C_number=StringField('phone',validators=[DataRequired()])
    C_state=StringField('state',validators=[DataRequired(),Length(min=3,max=15)])
    C_pincode=StringField('pincode',validators=[DataRequired()])
    C_address=StringField('address',validators=[DataRequired(),Length(min=10,max=40)])
